...
Array.from(menuItems).forEach(function (item, index) {
  item.onclick = function (e) {
    var currMenu = document.querySelector('.menu-item.active');
...
Array.from(categories).forEach(function (item, index) {
  item.onclick = function (e) {
    var currCat = foodCategory.querySelector('button.active');
...
loop = function (_loop) {
  ...
  elToShow.forEach(function (item, index) {
...
var bottomNavItems = document.querySelectorAll('.mb-nav-item');
var bottomMove = document.querySelector('.mb-move-item');
bottomNavItems.forEach(function (item, index) {
  item.onclick = function (e) {
    console.log('object');
    var crrItem = document.querySelector('.mb-nav-item.active');
...
//# sourceMappingURL=/responsive-animate-food-landing-page-main.e31bb0bc.js.map